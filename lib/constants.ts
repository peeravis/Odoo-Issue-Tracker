...
export const UPLOAD_DIR = process.env.UPLOAD_DIR ?? `${process.cwd()}/uploads`;
...
// Allowed extensions — must match ALLOWED_ATTACHMENT_TYPES (defense-in-depth against MIME spoofing)
