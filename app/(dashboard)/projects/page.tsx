    ...
    <div className="space-y-6">
      ...
      <StaggerList className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {projects.map((project) => (
          ...
          <div
            className={`bg-white dark:bg-gray-800/80 rounded-2xl border shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 p-6 flex flex-col gap-3 h-full ${
